  ...
  <!-- Sidebar -->
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Mohammad Asif</a>
        </div>
      </div>
  <!-- SidebarSearch Form -->
  <!-- Sidebar Menu -->
...
<form>
      ...
      <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                    ...
                    <input type = "submit" class="btn-primary" name="upadte-section" value="save changes"> 
</form>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy;2022<a href="#">Mohammad Asif</a>.</strong>All rights reserved.
